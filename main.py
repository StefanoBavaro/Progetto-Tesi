...
net_embedding= 1 #0 = embedding, 1 = word_to_vec
...
#                     }
#     outfile = open('../Progetto-Tesi/data/log_files/' + log_name +'_'+net_embedding +'_doubleOutput.log', 'w')
# elif(net_out==1):
#     search_space = {'output_dim_embedding':scope.int(hp.loguniform('output_dim_embedding', np.log(10), np.log(150))),
#                     'shared_lstm_size': scope.int(hp.loguniform('shared_lstm_size', np.log(10), np.log(150))),
#                     'lstmA_size_1':  scope.int(hp.loguniform('lstmA_size_1', np.log(10), np.log(150))),
...
#                     'learning_rate': hp.loguniform("learning_rate", np.log(0.00001), np.log(0.01))
#                     }
#     outfile = open('../Progetto-Tesi/data/log_files/' + log_name+'_'+net_embedding + '_singleActOutput.log', 'w')
#
# elif(net_out==2):
#      search_space = {'output_dim_embedding':scope.int(hp.loguniform('output_dim_embedding', np.log(10), np.log(150))),
#                      'shared_lstm_size': scope.int(hp.loguniform('shared_lstm_size', np.log(10), np.log(150))),
...
#                     'learning_rate': hp.loguniform("learning_rate", np.log(0.00001), np.log(0.01))
#                     }
#      outfile = open('../Progetto-Tesi/data/log_files/' + log_name +'_'+net_embedding+ '_singleOutOutput.log', 'w')
#
# best_params = fmin(
#       fn=manager.nn,
#       space=search_space,
